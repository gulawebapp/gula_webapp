    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <section className="mb-16">
        <div className="flex justify-between items-center mb-6">
          ...
          <a href="#" className="text-blue-600 hover:text-blue-800 font-medium">Browse all</a>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {popularProducts.map((product) => (
            <div 
              key={product.id} 
              className="border border-gray-200 rounded-xl overflow-hidden hover:shadow-md transition-shadow duration-300 bg-white"
            >
      ...
      <section className="mb-16 bg-gray-50 rounded-xl p-8">
        <h2 className="text-2xl font-bold text-center mb-8 text-gray-800">Why Choose Our B2B Marketplace?</h2>
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center">
            <div className="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              <FaStar className="h-6 w-6 text-blue-600" />
            </div>
            <h3 className="font-semibold text-lg mb-2 text-gray-800">Verified Suppliers</h3>
            <p className="text-gray-600">All businesses undergo strict verification to ensure reliability and quality.</p>
          </div>
          <div className="text-center">
            <div className="bg-green-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              <FaStar className="h-6 w-6 text-green-600" />
            </div>
            <h3 className="font-semibold text-lg mb-2 text-gray-800">Competitive Pricing</h3>
            <p className="text-gray-600">Access wholesale prices that help maximize your profit margins.</p>
          </div>
          <div className="text-center">
            <div className="bg-purple-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              <FaStar className="h-6 w-6 text-purple-600" />
            </div>
            <h3 className="font-semibold text-lg mb-2 text-gray-800">Efficient Order Management</h3>
            <p className="text-gray-600">Streamlined processes for quotes, orders, and payments.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-blue-600 rounded-xl p-8 text-center text-white">
        ...
        <p className="mb-6 max-w-2xl mx-auto">Join thousands of retailers and wholesalers who are already benefiting from our platform.</p>
